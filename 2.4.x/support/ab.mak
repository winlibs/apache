...
$(DS_POSTBUILD_DEP) : "aprutil - Win32 Release" "apr - Win32 Release" "$(OUTDIR)\ab.exe"
...
$(DS_POSTBUILD_DEP) : "aprutil - Win32 Debug" "apr - Win32 Debug" "$(OUTDIR)\ab.exe"
...
"$(INTDIR)\ab.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\ab.res" /i "../include" /i "../srclib/apr/include" /i "$(SRCROOT)\build\win32" /d "NDEBUG" /d "APP_FILE" /d BIN_NAME="ab.exe" /d LONG_NAME="ApacheBench command line utility" $(SOURCE)
...
"$(INTDIR)\ab.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\ab.res" /i "../include" /i "../srclib/apr/include" /i "$(SRCROOT)\build\win32" /d "_DEBUG" /d "APP_FILE" /d BIN_NAME="ab.exe" /d LONG_NAME="ApacheBench command line utility" $(SOURCE)
