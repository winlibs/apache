...
$(DS_POSTBUILD_DEP) : "aprutil - Win32 Release" "apr - Win32 Release" "$(OUTDIR)\wintty.exe"
...
$(DS_POSTBUILD_DEP) : "aprutil - Win32 Debug" "apr - Win32 Debug" "$(OUTDIR)\wintty.exe"
...
"$(INTDIR)\wintty.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\wintty.res" /i "../../include" /i "../../srclib/apr/include" /i "$(SRCROOT)\build\win32" /d "NDEBUG" /d "APP_FILE" /d BIN_NAME="wintty.exe" /d LONG_NAME="Apache wintty console pipe" $(SOURCE)
...
"$(INTDIR)\wintty.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\wintty.res" /i "../../include" /i "../../srclib/apr/include" /i "$(SRCROOT)\build\win32" /d "_DEBUG" /d "APP_FILE" /d BIN_NAME="wintty.exe" /d LONG_NAME="Apache wintty console pipe" $(SOURCE)
