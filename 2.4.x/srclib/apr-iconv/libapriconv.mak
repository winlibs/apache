...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib advapi32.lib /nologo /base:"0x6EE50000" /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\libapriconv.pdb" /debug /machine:I386 /out:"$(OUTDIR)\libapriconv.dll" /implib:"$(OUTDIR)\libapriconv.lib" /opt:ref 
LINK32_OBJS= \
	"$(INTDIR)\iconv.obj" \
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib advapi32.lib /nologo /base:"0x6EE50000" /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\libapriconv.pdb" /debug /machine:I386 /out:"$(OUTDIR)\libapriconv.dll" /implib:"$(OUTDIR)\libapriconv.lib" 
LINK32_OBJS= \
	"$(INTDIR)\iconv.obj" \
	"$(INTDIR)\iconv_ces.obj" \
	"$(INTDIR)\iconv_ces_euc.obj" \
